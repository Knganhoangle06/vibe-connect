...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $posts = [
            ...
            [
                'id' => 6, 'user_id' => 3, 'original_post_id' => null,
            ...
            [
                'id' => 7, 'user_id' => 1, 'original_post_id' => 5, // Trang share bài tuyển dụng
                'content' => 'Cơ hội tốt cho mấy ông PNV nè, apply lẹ đi!',
                'media_url' => null, 'media_type' => null, 'created_at' => Carbon::now()->subMinutes(15)
            ],
            [
                'id' => 8, 'user_id' => 3, 'original_post_id' => 2, // Nam share bài portfolio của Trang
