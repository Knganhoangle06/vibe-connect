<nav>
    ...
    <div class="nav-icon">
        ...
        <a href="{{ route('search.index') }}" class="{{ request()->routeIs('search.index') ? 'active' : '' }}"
            title="Khám phá">
            <i class="fa-solid fa-compass icon"></i><span>Khám phá</span>
        </a>
        <a href="{{ route('friend.show') }}" class="{{ request()->routeIs('friend.show') ? 'active' : '' }}"
            title="Bạn bè">
    ...
    <div class="profile-menu-wrapper">
        ...
        <div class="profile-dropdown" id="profileDropdown">
            ...
            <ul class="menu-list">
                <li>
                    <a href="#"><i class="fa-solid fa-gear"></i> Cài đặt và quyền riêng tư <i
                            class="fa-solid fa-chevron-right arrow-right"></i></a>
                </li>
                <li>
                    <a href="#"><i class="fa-solid fa-circle-question"></i> Trợ giúp và hỗ trợ <i
                            class="fa-solid fa-chevron-right arrow-right"></i></a>
                </li>
                <li>
...
<script>
    ...
    // Đóng menu khi click ra ngoài vùng avatar/menu
